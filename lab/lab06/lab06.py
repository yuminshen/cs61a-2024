class Transaction:
    ...
    def report(self):
        ...
        if self.changed():
            ...
            if before < after :
                msg = 'increased ' + str(before) + '->' + str(after)
            else :
                msg = 'decreased ' + str(before) + '->' + str(after)
...
class Account:
    ...
    def __init__(self, account_holder, transactions=[]):
        self.balance = 0
    ...
    def deposit(self, amount):
        ...
        self.transactions += [Transaction(len(self.transactions),
...
class ChangeMachine:
    ...
    def change(self, coin):
        ...
        if result == None:
            return [coin]
        for q in result:
            self.coins = remove_one(self.coins, q)
